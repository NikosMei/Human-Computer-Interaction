...
public class ScenarioSelect extends AppCompatActivity {

    private ScenariosAdapter.OnClickListener onClickListener;
    ...
    private ArrayList<Script> scenarios;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scenarios = (ArrayList<Script>) args.getSerializable("VIEWSCENARIOS");
        setOnClickListener();
        ScenariosAdapter scenariosAdapter = new ScenariosAdapter(getApplicationContext(),scenarios,onClickListener);
    ...
    private void setOnClickListener() {
        onClickListener = new ScenariosAdapter.OnClickListener() {
            @Override
            public void onClick(View v, int position) {
                Intent intent = new Intent(getApplicationContext(), Scenario.class);
                ...
                intent.putExtra("SELECTEDSCENARIO",position);
